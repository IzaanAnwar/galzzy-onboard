          ...
          <div className="container space-y-12 px-4 md:px-6">
            ...
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              ...
              <Card className="grid gap-1 border border-background bg-background p-4 shadow-none duration-300 hover:border-primary">
                ...
                <p className="text-sm">
                  Easily manage and collaborate on your videos, ensuring they
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link className="inline-flex" color="primary">
                Learn More
              </Link>
            </div>
          </div>
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Galzzy ensures seamless and reliable management for all your
                video needs.
              </p>
            </div>
            <SignupForm />
